<div class="container d-flex justify-content-center">
    <div class="col-md-4 mt-4">
        <div class="card mb-5" style="-webkit-box-shadow: -1px 20px 66px -21px rgba(0,0,0,0.59);
-moz-box-shadow: -1px 20px 66px -21px rgba(0,0,0,0.59);
box-shadow: -1px 20px 66px -21px rgba(0,0,0,0.59);">
            <div class="card-header bg-primary">
                <h4 style="color:white;">Daftar akun Dosen</h4>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <button type="submit" name="daftardosen" class="btn btn-primary mt-4 form-control">Daftar</button>
                </form>
            </div>
            <div class="card-footer bg-white">
                Sudah memiliki akun? <a href="index.php?h=login" type="button" class="" style="text-decoration:none;">
                    Masuk disini
                </a>
            </div>
        </div>
